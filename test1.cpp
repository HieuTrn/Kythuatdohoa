...
namespace test1 {
	...
	const int N_LINES = 11;
	double model[N_LINES][2][3] = {
	{ { -0.8, 0.3, 0.0 }, { -0.8, 0.7, 0.0} },
	{ { -0.8, 0.5, 0.0 }, { -0.7, 0.5, 0.0} },
	{ { -0.7, 0.3, 0.0}, { -0.7, 0.7, 0.0} },
	{ {-0.6, 0.3, 0.0}, {-0.6, 0.7, 0.0} },
	{ {-0.5, 0.3, 0.0 }, { -0.5, 0.7, 0.0} },
	{ {-0.5, 0.3, 0.0}, {-0.4, 0.3, 0.0} },
	{ {-0.5, 0.5, 0.0}, {-0.4, 0.5, 0.0} },
	{ {-0.5, 0.7, 0.0}, {-0.4, 0.7, 0.0} },
	{ {-0.3, 0.3, 0.0}, {-0.3, 0.7, 0.0} },
	{ {-0.3, 0.3, 0.0}, {-0.2, 0.3, 0.0} },
	{ {-0.2, 0.3, 0.0}, {-0.2, 0.7, 0.0} }
	};
	void render() {
		glBegin(GL_LINES);
